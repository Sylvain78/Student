...
#include "server/server_protocol.pb.h"
...
static ::_pb::Metadata file_level_metadata_server_2fserver_5fprotocol_2eproto[14];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_server_2fserver_5fprotocol_2eproto[3];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_server_2fserver_5fprotocol_2eproto = nullptr;

const uint32_t TableStruct_server_2fserver_5fprotocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_server_2fserver_5fprotocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\034server/server_protocol.proto\":\n\020Notati"
  "on_element\022\017\n\005param\030\001 \001(\tH\000\022\020\n\006string\030\002 "
  "\001(\tH\000B\003\n\001t\"\374\007\n\007Command\022\021\n\007verbose\030\001 \001(\005H"
  "\000\022\035\n\004prop\030\002 \001(\0132\r.Command.PropH\000\0221\n\016keep"
  "_notations\030\003 \001(\0132\027.Command.Keep_notation"
  "sH\000\0225\n\020expand_notations\030\004 \001(\0132\031.Command."
  "Expand_notationsH\000\022%\n\010compiled\030\005 \001(\0132\021.C"
  "ommand.CompiledH\000\022+\n\013interpreted\030\006 \001(\0132\024"
  ".Command.InterpretedH\000\022\035\n\004save\030\007 \001(\0132\r.C"
  "ommand.FileH\000\022\035\n\004load\030\010 \001(\0132\r.Command.Fi"
  "leH\000\022+\n\013first_order\030\t \001(\0132\024.Command.Firs"
  "t_orderH\000\022%\n\010notation\030\n \001(\0132\021.Command.No"
  "tationH\000\022#\n\007theorem\030\013 \001(\0132\020.Command.Theo"
  "remH\000\022\037\n\005axiom\030\014 \001(\0132\016.Command.AxiomH\000\022#"
  "\n\007history\030\r \001(\0132\020.Command.HistoryH\000\022\016\n\004s"
  "how\030\016 \001(\tH\000\022\026\n\004list\030\017 \001(\0162\006.KnownH\000\022\035\n\004q"
  "uit\030\020 \001(\0132\r.Command.QuitH\000\032\006\n\004Prop\0322\n\004Fi"
  "le\022\030\n\004mode\030\001 \001(\0162\n.File_mode\022\020\n\010filename"
  "\030\002 \001(\t\032\020\n\016Keep_notations\032\022\n\020Expand_notat"
  "ions\032\n\n\010Compiled\032\r\n\013Interpreted\032\r\n\013First"
  "_order\032q\n\010Notation\022\014\n\004name\030\001 \001(\t\022\016\n\006para"
  "ms\030\002 \003(\t\022!\n\006syntax\030\003 \003(\0132\021.Notation_elem"
  "ent\022$\n\tsemantics\030\004 \003(\0132\021.Notation_elemen"
  "t\032~\n\007Theorem\022\014\n\004name\030\001 \001(\t\022\016\n\006params\030\002 \003"
  "(\t\022\021\n\tpremisses\030\003 \003(\t\022\022\n\nconclusion\030\004 \001("
  "\t\022\025\n\rdemonstration\030\005 \003(\t\022\027\n\006status\030\006 \001(\016"
  "2\007.Status\032&\n\005Axiom\022\014\n\004name\030\001 \001(\t\022\017\n\007form"
  "ula\030\002 \001(\t\032\t\n\007History\032\006\n\004QuitB\003\n\001t*!\n\tFil"
  "e_mode\022\010\n\004TEXT\020\000\022\n\n\006BINARY\020\001*1\n\006Status\022\016"
  "\n\nUNVERIFIED\020\000\022\014\n\010VERIFIED\020\001\022\t\n\005FALSE\020\002*"
  "!\n\005Known\022\n\n\006AXIOMS\020\000\022\014\n\010THEOREMS\020\001b\006prot"
  "o3"
  ;
static ::_pbi::once_flag descriptor_table_server_2fserver_5fprotocol_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_server_2fserver_5fprotocol_2eproto = {
    false, false, 1242, descriptor_table_protodef_server_2fserver_5fprotocol_2eproto,
    "server/server_protocol.proto",
    &descriptor_table_server_2fserver_5fprotocol_2eproto_once, nullptr, 0, 14,
    schemas, file_default_instances, TableStruct_server_2fserver_5fprotocol_2eproto::offsets,
    file_level_metadata_server_2fserver_5fprotocol_2eproto, file_level_enum_descriptors_server_2fserver_5fprotocol_2eproto,
    file_level_service_descriptors_server_2fserver_5fprotocol_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_server_2fserver_5fprotocol_2eproto_getter() {
  return &descriptor_table_server_2fserver_5fprotocol_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_server_2fserver_5fprotocol_2eproto(&descriptor_table_server_2fserver_5fprotocol_2eproto);
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* File_mode_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_server_2fserver_5fprotocol_2eproto);
  return file_level_enum_descriptors_server_2fserver_5fprotocol_2eproto[0];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Status_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_server_2fserver_5fprotocol_2eproto);
  return file_level_enum_descriptors_server_2fserver_5fprotocol_2eproto[1];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Known_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_server_2fserver_5fprotocol_2eproto);
  return file_level_enum_descriptors_server_2fserver_5fprotocol_2eproto[2];
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Notation_element::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Command_Prop::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Command_File::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[2]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Command_Keep_notations::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[3]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Command_Expand_notations::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[4]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Command_Compiled::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[5]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Command_Interpreted::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[6]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Command_First_order::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[7]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Command_Notation::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[8]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Command_Theorem::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[9]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Command_Axiom::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[10]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Command_History::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[11]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Command_Quit::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[12]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Command::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_server_2fserver_5fprotocol_2eproto_getter, &descriptor_table_server_2fserver_5fprotocol_2eproto_once,
      file_level_metadata_server_2fserver_5fprotocol_2eproto[13]);
}
